"""2 Conv + 2 Dense test problem on Fashion-MNIST for PyTorch DeepOBS."""
...
class fmnist_2c2d(TestProblem):
    """DeepOBS test problem class for a 2 conv + 2 dense network on Fashion-MNIST.
    ...
    def __init__(self, batch_size, weight_decay=None, device=None):
        """Create a new 2C2D test problem on Fashion-MNIST.
        ...
        """
        super(fmnist_2c2d, self).__init__(batch_size, weight_decay, device)
    ...
    def set_up(self):
        """Set up the 2C2D test problem on Fashion-MNIST."""
        # Create dataset
