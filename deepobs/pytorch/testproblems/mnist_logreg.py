"""Logistic regression test problem on MNIST for PyTorch DeepOBS."""
...
class mnist_logreg(TestProblem):
    """DeepOBS test problem class for logistic regression on MNIST.
    ...
    def __init__(self, batch_size, weight_decay=None, device=None):
        """Create a new logistic regression test problem on MNIST.
        ...
        """
        super(mnist_logreg, self).__init__(batch_size, weight_decay, device)
    ...
    def set_up(self):
        """Set up the logistic regression test problem on MNIST."""
        # Create dataset
