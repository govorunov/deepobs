"""VGG 19 architecture for ImageNet."""
...
class imagenet_vgg19(TestProblem):
    ...
    def __init__(self, batch_size, weight_decay=5e-4, device=None):
        ...
        Args:
            ...
            device (str or torch.device, optional): Device to use.
        """
        super(imagenet_vgg19, self).__init__(batch_size, weight_decay, device)
    ...
    def set_up(self):
        ...
        self.model = vgg19(num_outputs=1000, input_size=(224, 224))
