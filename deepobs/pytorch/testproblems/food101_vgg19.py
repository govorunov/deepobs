"""VGG 19 architecture for Food-101."""

import torch
import torch.nn.functional as F

from ._vgg import vgg19
from ..datasets.food101 import Food101
from .testproblem import TestProblem


class food101_vgg19(TestProblem):
    """DeepOBS test problem class for the VGG 19 network on Food-101.
    ...
    def __init__(self, batch_size, weight_decay=5e-4, device=None):
        """Create a new VGG 19 test problem instance on Food-101.
        ...
        Args:
            ...
            device (str or torch.device, optional): Device to use.
        """
        super(food101_vgg19, self).__init__(batch_size, weight_decay, device)

    def set_up(self):
        """Set up the VGG 19 test problem on Food-101."""
        # Initialize dataset
        self.dataset = Food101(self._batch_size)

        # Initialize model with BatchNorm and reduced dropout
        self.model = vgg19(num_outputs=101, input_size=(224, 224),
