"""Multi-layer perceptron test problem on MNIST for PyTorch DeepOBS."""
...
class mnist_mlp(TestProblem):
    """DeepOBS test problem class for a multi-layer perceptron on MNIST.
    ...
    def __init__(self, batch_size, weight_decay=None, device=None):
        """Create a new MLP test problem on MNIST.
        ...
        """
        super(mnist_mlp, self).__init__(batch_size, weight_decay, device)
    ...
    def set_up(self):
        """Set up the MLP test problem on MNIST."""
        # Create dataset
