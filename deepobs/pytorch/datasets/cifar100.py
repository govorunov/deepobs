"""CIFAR-100 dataset for DeepOBS PyTorch backend."""
...
class CIFAR100(DataSet):
    """DeepOBS dataset class for CIFAR-100.

    The CIFAR-100 dataset consists of 50,000 training images and 10,000 test images
    across 100 fine-grained classes (grouped into 20 superclasses). Images are 32x32 RGB.

    This implementation uses torchvision.datasets.CIFAR100 for automatic downloading
    ...
    def __init__(
        ...
        """Creates a new CIFAR-100 dataset instance.
